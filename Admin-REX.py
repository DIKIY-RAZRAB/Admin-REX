...
print("▏┃       ┃▕    ▒█▄▄▀ ▄█▄ ▒█░▒█ ▄█▄ ░░▒█░░ 　 ▒█░▒█ ▒█░▒█ ▀▀▀ ▒█░▒█ ▒█░▒█ ▒█▄▄█")
print("▏▏       ▕▕    ")
print("╲┃▉▉◣ ◢▉▉┃╱           ДЛЯ ДИКАРЕЙ ОБИТАЮЩИХ ПО АДРЕСУ : https://t.me/dikiy_raZrab")
print(" ▏▉▉◤ ◥▉▉▕     ")
print("╭▏  ◢▉◣  ▕╮         ")
print("╰━╮ ◤▅◥ ╭━╯")
print(" ╲┃.    .┃╱")
print(" ▕╰.╋╋╋╋.╯▏")
print("  ╲▂▂▂▂▂╱")
url = input("ССЫЛКА НА САЙТ ЧЕРЕЗ https ИЛИ http : ")
print("")
print("                                                                                        ")
...
'adminarea/admin.brf','adminarea/login.brf','panel-administracion/index.brf','panel-administracion/admin.brf','modelsearch/index.brf','админ','админка','панель',
...
for link2 in link :
    ...
    try :
        ...
        print(Fore.GREEN + "ПАНЕЛЬ НАЙДЕНА: "+link3)


    except urllib.error.URLError as msg :
        
        print (Fore.RED + "ПАНЕЛЬ НЕ НАЙДЕНА : "+link3)

print (Fore.MAGENTA + "ПОИСК ОКОНЧЕН: можешь шариться. =)")
